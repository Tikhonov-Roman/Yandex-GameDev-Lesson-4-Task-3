...
namespace Asteroids.Model
{
    public class Ship : Transformable, IUpdatable
    {
        ...
        public Ship(Vector2 position, float rotation, int lifesCount) : base(position, rotation) {_lifesCount = lifesCount; }
        ...
        {
            _lifesCount -= damage;
            Debug.Log($"{damage} Damage Taken. {_lifesCount} lifes left");
        }
        public bool IsDead()
        {
